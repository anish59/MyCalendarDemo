...
public class MFCalendarView2 extends LinearLayout{
	...
	public MFCalendarView2(Context context) {
		super(context);
		init(context);
	}
	...
	public MFCalendarView2(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		init(context);
	}

	public MFCalendarView2(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(context);
	}
	...
	public void setDate(String date){
		if (date.equals(MFCalendarView2.TODAY)) {
